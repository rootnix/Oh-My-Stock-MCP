...
- 지원 브로커: `samsungpop`, `shinhansec`, `miraeasset`, `nhsec`, `korsec`, `kiwoom`
...
| 한국투자증권 (ID 로그인) | `korsec` | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | 브라우저 자산/잔고 중심 지원 |
| 한국투자증권 OpenAPI | `korsec` | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ | App Key / Secret 기반, 거래·기간손익 포함 |
| 키움증권 OpenAPI | `kiwoom` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | REST OpenAPI(app key/secret) 기반 지원 |

### 상세 매트릭스

| 기능 | 삼성증권 | 신한투자증권 | 미래에셋증권 | NH투자증권 | 한국투자증권 ID | 한국투자증권 OpenAPI | 키움증권 OpenAPI |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 총자산 요약 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 계좌 목록 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 계좌별 상세 | ✅ | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ⚠️ |
...
\** 한국투자증권 OpenAPI의 입출금/주식거래/성과 이력은 실계정 검증 범위가 아직 제한적입니다. 미래에셋 `Deep Snapshot`은 현재 자산 중심입니다.
